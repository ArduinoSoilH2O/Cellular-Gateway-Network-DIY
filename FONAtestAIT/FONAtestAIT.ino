/* This is an edited version of the FONAtest.ino sketch, edited
   to work with the Gateway PCB. Note that not all the menu options
   work with the 3G module.

   Enter APN in line 121.
